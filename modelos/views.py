...
def filtros(request):
    ...
    print(KNN_3_Form,KNN_NE_Form,KNN_NC_Form,KNN_EC_Form,KNN_NO_Form,KNN_EO_Form)
    print(genero, edad_min, edad_max, fecha_ingreso_ini, fecha_ingreso_fin)
    ...
    if(algoritmo == 'KNN'):
        ...
        context['NE'] = 'Exactitud: 61%'
        context['NC'] = 'Exactitud: 61%'
        context['EC'] = 'Exactitud: 63%'
        context['NO'] = 'Exactitud: 68%'
