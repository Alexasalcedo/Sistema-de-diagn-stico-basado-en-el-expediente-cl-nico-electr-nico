                ...
                with os.scandir(ejemplo_dir) as ficheros:
                    ...
                    if len(dir) == 0:
                        ...
                        for fichero in ficheros:
                            print("Soy los nombres del fichero 1",fichero.name) 
                ...
                with os.scandir(ejemplo_dir2) as ficheros2:
                    ...
                    if len(dir2) == 0:
                        ...
                        for fichero2 in ficheros2:
                            print("Soy los nombres del fichero 2",fichero2.name) 
                ...
                with os.scandir(ejemplo_dir31) as ficheros31:
                    ...
                    if len(dir31) == 0:
                        ...
                        for fichero31 in ficheros31:
                            print("Soy los nombres del fichero 3 de Embolia",fichero31.name) 
                ...
                with os.scandir(ejemplo_dir32) as ficheros32:
                    ...
                    if len(dir32) == 0:
                        ...
                        for fichero32 in ficheros32:
                            print("Soy los nombres del fichero 3 de Control",fichero32.name) 
                ...
                with os.scandir(ejemplo_dir33) as ficheros33:
                    ...
                    if len(dir33) == 0:
                        ...
                        for fichero33 in ficheros33:
                            print("Soy los nombres del fichero 3 de Control",fichero33.name) 
                ...
                with os.scandir(ejemplo_dir4) as ficheros4:
                    ...
                    if len(dir4) == 0:
                        ...
                        for fichero4 in ficheros4:
                            print("Soy los nombres del fichero 4",fichero4.name) 
                ...
                with os.scandir(ejemplo_dir5) as ficheros5:
                    ...
                    if len(dir5) == 0:
                        ...
                        for fichero5 in ficheros5:
                            print("Soy los nombres del fichero 5",fichero5.name) 
                            nss = fichero5.name[0:10]
                            nss = float(nss)
                            nss = floor(nss)
                            print(nss)
                            try:
